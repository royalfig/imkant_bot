...
1. Parse RSS feed and create array of data
2. Create article for each item
3. Post items to Ghost
...
const data = rss(url).then(result => {
  const test = result.items.map(item => item);
  return test;
});
